...
class InstructorFileControllerE2ETest {
    ...
    void testFileUpload_Forbidden() {
        ...
        ResponseEntity<String> responseEntity = restTemplate.exchange(
                buildUrl("/api/v1/files/upload", userId, lessonId),
                HttpMethod.POST,
                requestEntity,
                String.class
        );
    ...
    void testDownloadFile() {
        ...
        String downloadUrl = buildUrl("/api/v1/files/download/{fileId}", fileId);
