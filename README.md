...
---------
11. To register new user open this url:
```
ec2-52-91-61-185.compute-1.amazonaws.com/api/v1/auth/register
```
Register params:
```java
...
```
-------
12. To Create course use this url
```
...
```
13. To edit existed course use this link: 
```
http://localhost:8080/api/v1/course/edit
```
...
14. To start course use this url:
```
http://localhost:8080/api/v1/course
```
And use these params:
```java
    private Long courseId;
    private String action (start/stop);
```

15. To remove course use this url:
```
http://localhost:8080/api/v1/course/10
```

16. To get course by id use this link:
````
http://localhost:8080/api/v1/course/1
````
17. To finish course use this link: 
```
http://localhost:8080/api/v1/course/finish
```
And use this params: 
```java
    private Long courseId;
...
18. To get courses by userId use this url:
```
http://localhost:8080/api/v1/course/user/4
```

19. To find all courses use this link:
```
http://localhost:8080/api/v1/course/find-all
```

20. To get all users assigned to course use this url:
```
http://localhost:8080/api/v1/course/instructor/users
```
And use next params: 
...
21. To get all lessons by course and userId use this url:
```
http://localhost:8080/api/v1/course/student/lessons
```

22. To get all information about lessons by user on the course use this link:
```
http://localhost:8080/api/v1/course/student/lessons
```
And use these params:
